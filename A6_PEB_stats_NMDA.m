...
for p = 1:length(participant)
    ...
    try
        load([outcome_path '/' participant{p} '_' modality_data '_DCM_NMDA_' MMN_types '_solved' tag_DCM_solved '.mat']);
    catch
        error(['No ' participant{p} '_' modality_data '_DCM_NMDA_' MMN_types '_solved' tag_DCM_solved '.mat file found']);
    end
...
spm_dcm_peb_review_Fran(BMA,GCM)
